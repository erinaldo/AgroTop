...
{
    public partial class RecomendacionPreSiembra : ISynSerializable, IBaseEntity
    {
        public static string XmlTag = "reps";

        public string[] SyncProperties
        {
            get { return new[] { "IdFichaPreSiembra", "IdQuimico", "FechaAplicacion", "Dosis", "IdUM", "FerN", "FerP2O5", "FerKO2", "FerMgO", "FerS", "FerB", "FerZn", "FerCaO", "ID" }; }
            set { }
        }

        public int ID
        {
            get { return this.IdRecomendacionPreSiembra; }
        }

        public System.Xml.Linq.XElement Serialize()
        {
            var element = new System.Xml.Linq.XElement(RecomendacionPreSiembra.XmlTag);
            element.SetAttributeValue("id", this.IdRecomendacionPreSiembra);
        ...
        public static RecomendacionPreSiembra CreateNew(string mobileTag, int idFichaPreSiembra, string username)
        {
            return new RecomendacionPreSiembra()
            {

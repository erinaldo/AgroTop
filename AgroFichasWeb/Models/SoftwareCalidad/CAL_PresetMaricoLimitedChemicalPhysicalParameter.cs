...
{
    public partial class CAL_PresetMaricoLimitedChemicalPhysicalParameter
    {
        ...
        public IEnumerable<SelectListItem> GetParametros(int? IdParametroAnalisis)
        {
            IEnumerable<SelectListItem> selectList = (from X in dc.CAL_ParametroAnalisis
                                                      where X.Habilitado == true
                                                      orderby X.Nombre
                                                      select new SelectListItem
                                                      {

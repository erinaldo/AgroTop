...
{
    public partial class CAL_CertificadoCertificateAnalysis
    {
        ...
        {
            IEnumerable<SelectListItem> selectList = from X in dcSoftwareCalidad.CAL_GetLotesMaricoLimited()
        ...
        public IEnumerable<RuleViolation> GetRuleViolations()
        {
            ...
            if (this.DispatchDate == null)
                yield return new RuleViolation("La fecha de envío es requerida", "DispatchDate");

            if (string.IsNullOrEmpty(this.CommercialInvoice))
                yield return new RuleViolation("La factura es requerida", "CommercialInvoice");

            if (string.IsNullOrEmpty(this.Guide))
                yield return new RuleViolation("La guía(s) de despacho es/son requerida(s)", "Guide");

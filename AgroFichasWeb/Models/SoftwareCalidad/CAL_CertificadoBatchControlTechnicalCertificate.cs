...
{
    public partial class CAL_CertificadoBatchControlTechnicalCertificate
    {
        ...
        public IEnumerable<RuleViolation> GetRuleViolations()
        {
            ...
            //if (string.IsNullOrEmpty(this.ProductionDate))
            //    yield return new RuleViolation("La fecha de producción es requerida", "ProductionDate");

            if (string.IsNullOrEmpty(this.ProcessCode))
                yield return new RuleViolation("El código del proceso es requerido", "ProcessCode");

            if (string.IsNullOrEmpty(this.Presentation))
                yield return new RuleViolation("La presentación es requerida", "Presentation");

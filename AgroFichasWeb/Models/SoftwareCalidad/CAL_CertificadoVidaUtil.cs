...
{
    public partial class CAL_CertificadoVidaUtil
    {
        ...
        public IEnumerable<RuleViolation> GetRuleViolations()
        {
            ...
            if (string.IsNullOrEmpty(this.Reserva))
                yield return new RuleViolation("La reserva es requerida", "Reserva");
            ...
            if (this.FechaEmbarque == null)
                yield return new RuleViolation("La fecha de embarque es requerida", "FechaEmbarque");

...
{
    public partial class ADQ_Documento
    {
        ...
        public string GetArchivo()
        {
            ...
            {
                return string.Format("<a href=\"{0}\"><img src=\"{0}\" alt=\"{1}\" width=\"{2}\"></a>", string.Format("{0}/uploads/adquisiciones/{1}", Util.HttpBasePath(), this.NombreArchivo), "", 350);
            }
            else
            {
                return string.Format("<a href=\"{0}\" class=\"btn btn-primary\" target=\"_blank\">{1}</a>", string.Format("{0}/uploads/adquisiciones/{1}", Util.HttpBasePath(), this.NombreArchivo), "Descargar Archivo");
            }
    }
        ...
        public string GetArchivoMini()
        {
            ...
            {
                return string.Format("<a href=\"{0}\">{1}</a>", string.Format("{0}/CALFTDoc/Descargar/{1}", Util.HttpBasePath(), this.IdDocumento), "Descargar Archivo");
            }
        }
        #endregion

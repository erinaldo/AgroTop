...
{
    [WebsiteAuthorize]
    public class CALCertificadoGranelCalidadController : BaseApplicationController
    {
        private SoftwareCalidadDBDataContext dcSoftwareCalidad = new SoftwareCalidadDBDataContext();
        private AgroFichasDBDataContext dcAgroFichas = new AgroFichasDBDataContext();

        public CALCertificadoGranelCalidadController()
        {
            SetCurrentModulo(10);
        }

        // GET: CALCertificadoGranelCalidad
        ...
        public ActionResult CrearPDF(int id)
        {
            ...
            RepTemp(ref htmlContent, "TON"        , certificadoCargaGranel.Toneladas.ToString("N2"));

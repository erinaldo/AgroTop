...
{
    public class VerificacionAnalisisViewModel
    {
        ...
        public VerificacionAnalisisViewModel()
        {

        }

        public VerificacionAnalisisViewModel(AgroFichasDBDataContext dc, int idProcesoIngreso)
        {
        ...
        {
            this.ProcesoIngreso = dc.ProcesoIngreso.Single(pi => pi.IdProcesoIngreso == this.IdProcesoIngreso && pi.IdEstado >= 4 && pi.IdEstado <= 9);
        ...
        {
            this.ProcesoIngreso.Verificado = true;
            ...
            this.ProcesoIngreso.FechaHoraVerifica = DateTime.Now;
            this.ProcesoIngreso.UserVerifica = userName;
            this.ProcesoIngreso.IpVerifica = ipAddress;

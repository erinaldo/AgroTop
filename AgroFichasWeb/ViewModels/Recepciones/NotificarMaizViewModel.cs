...
{
    public class NotificarMaizViewModel
    {
        ...
        public NotificarMaizViewModel()
        {

        }

        public NotificarMaizViewModel(AgroFichasDBDataContext dc, int idProcesoIngreso)
        {
        ...
        {
            this.ProcesoIngreso.Notificado = true;
            ...
            this.ProcesoIngreso.FechaHoraNotifica = DateTime.Now;
            this.ProcesoIngreso.UserNotifica = userName;
            this.ProcesoIngreso.IpNotifica = ipAddress;

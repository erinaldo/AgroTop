...
{
    public class CrearDoctoReLiquidacionViewModel
    {
        ...
        public CrearDoctoReLiquidacionViewModel()
        {

        }

        public CrearDoctoReLiquidacionViewModel(AgroFichasDBDataContext dc, int idLiquidacion)
        {

...
(function ($) {
	...
	*/
    ...
    if ($('#morrisBar-inicial').get(0)) {
        Morris.Bar({
            resize: true,
            element: 'morrisBar-inicial',
            data: morrisBarData_inicial,
            xkey: 'y',
            ykeys: ['a', 'b'],
            labels: ['Mts. Vac&iacute;os', 'Mts. Totales'],
            hideHover: true,
            barColors: ['#0088cc', '#2baab1']
        });
    }

    if ($('#morrisBar-ext-inicial').get(0)) {
        Morris.Bar({
            resize: true,
            element: 'morrisBar-ext-inicial',
            data: morrisBarData_ext_inicial,
            xkey: 'y',
            ykeys: ['a', 'b'],
            labels: ['Planchas', 'Max. Planchas'],
            hideHover: true,
            barColors: ['#0088cc', '#2baab1']
        });
    }

    if ($('#morrisBar-final').get(0)) {
        Morris.Bar({
            resize: true,
            element: 'morrisBar-final',
            data: morrisBarData_final,
            xkey: 'y',
            ykeys: ['a', 'b'],
            labels: ['Mts. Vac&iacute;os', 'Mts. Totales'],
            hideHover: true,
    ...
    if ($('#morrisBar-ext-final').get(0)) {
        Morris.Bar({
            resize: true,
            element: 'morrisBar-ext-final',
            data: morrisBarData_ext_final,
            xkey: 'y',
            ykeys: ['a', 'b'],
            labels: ['Planchas', 'Max. Planchas'],
            hideHover: true,
    ...
    if ($('#morrisBar-promediosCamionesPlanta').get(0)) {
        Morris.Bar({
            resize: true,
            element: 'morrisBar-promediosCamionesPlanta',
            data: morrisBarData_promediosCamionesPlanta,
            xkey: 'y',
            ykeys: ['a', 'b', 'c', 'd'],
            labels: ['Tiempo Prom. Ingreso', 'Tiempo Prom. Romana', 'Tiempo Prom. Salida', 'Tiempo Promedio'],
            hideHover: true,
            barColors: ['#2baab1', '#2baab1', '#2baab1', '#0088cc']
        });
    }
    ...
    (function () {
        if ($('#chartist-consumo-acumulado').get(0)) {
            new Chartist.Line('#chartist-consumo-acumulado', {
                ...
                series: [
                    [1000, 3000, 4000, 5000, 6000, 7000, 8000, 9000, 10000, 11000, 12000, 13000, 14000],
                    [],
